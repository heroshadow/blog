	...
	<table class="table table-bordered table-hover">
		...
		<?php foreach ($goodsData as $k=>$v){?>
			<tr class="info">
				...
				<td>
					<ul>
						<li>市场价：<del>&yen;<?php echo $v['mprice'];?></del></li>
						<li>商城价：<span>&yen;<?php echo $v['sprice'];?></span></li>
					</ul>
				</td>
				<td>
					<?php echo $v['tinventory'];?>
				</td>
				<td><?php echo $v['click'];?></td>
				<td><?php echo date("Y-m-d",$v['time']);?></td>
				<td>
					<a href="<?php echo U('GoodsList/index', array('gid' => $v['gid'], 'type_tid' => $v['type_tid']));?>" class="btn btn-success"><i class="icon-th icon-white"></i>货品列表</a>
