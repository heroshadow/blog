...
<head>
	...
	<script src="http://localhost/my_shop/9.11converse/hdphp/Public/Index/js/pay.js" type="text/javascript" charset="utf-8"></script>
	<script type="text/javascript">
		var oid ='<?php echo $odData['oid'];?>';
		var url = "<?php echo U('Pay/pay');?>"
		var root = 'http://localhost/my_shop/9.11converse/hdphp';
	</script>
</head>
<body class="newCartBody">
	<div class="carHeader">
		<div class="carHeaderCon clearfix">
			...
			<div class="fr" >
				<img src="http://localhost/my_shop/9.11converse/hdphp/Public/Index/images/c_19.jpg" alt="" width="350" height="70" />
			</div>
		</div>
	</div>
	<div class="center">
			...
			<div class="suc01 clearfix">
				<div class="suc01Left">
					<div class="sucList01">
						...
						<h3 class="sucText02"><span class="color333 padRight10">订单号:<a href="" style="color: #C69C6D;cursor: pointer;font-size: 14px;font-family: Tahoma,sans-serif;"><?php echo $odData['number'];?></a></span><span>应付金额: <strong><?php echo $odData['tprice'];?>元</strong></span></h3>
					...
					<p class="clearfix">
						<form action="" method="post">
							<input type="hidden" name="oid" id="" value="<?php echo $odData['oid'];?>" />
						<a href="javascript:;" class="fl a02">立即支付</a>
						</form>
					</p>
				</div>
			</div>
