	...
	<form action="" method='post'>
		...
		<table class="table table-bordered table-hover">
			<tr class="info">
				<td>品牌名称(英文)</td>
				<td colspan="2">
					<input type="text" name='bname' value="<?php echo $oldBrand['bname'];?>"/>
				</td>
			</tr>
			<tr class="info">
				<td>品牌名称(中文)</td>
			...
			<tr class="info uploadify-box">
				...
				<td>
					<div id='logo-wrap'>
						    <?php if($oldBrand['logo']){ ?>
	                	<li>
	                		<img src="http://127.0.0.1/my_shop/9.11converse/hdphp/<?php echo $oldBrand['logo'];?>" style="width: 200px;height: 50px;" alt="">
	                		<a href="javascript:;" class="del-img" path="<?php echo $oldBrand['logo'];?>">X</a>
	                	</li>
	                <?php } ?>
					</div>
				</td>
			...
			<tr class="info">
				<td>是否热门</td>
				<td colspan="2">
					<input type="radio" name='is_hot'     <?php if($oldBrand['is_hot']==1){ ?>checked<?php } ?> value='1'/>
					是
					<input type="radio" name='is_hot'     <?php if($oldBrand['is_hot']==0){ ?>checked<?php } ?> value='0'/>
					否
				</td>
			...
			<tr>
				<td colspan='3' align='center'>
					<input type="hidden" name="bid" value="<?php echo $hd['get']['bid'];?>" />
